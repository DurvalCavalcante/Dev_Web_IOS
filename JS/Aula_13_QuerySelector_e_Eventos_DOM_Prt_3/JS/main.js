document.body.style.background = '#c8c8a9';
...
let parClasse = (document.querySelector('p.exemplo').innerHTML = 'Mudei o texto aqui pelo JS');
...
for (i = 0; i < listaLi.length; i++) {
    listaLi[i].style.border = '1px solid #000';
...
myLi.forEach((li) => (li.innerHTML = 'Mudou aqui pelo JS!'));
