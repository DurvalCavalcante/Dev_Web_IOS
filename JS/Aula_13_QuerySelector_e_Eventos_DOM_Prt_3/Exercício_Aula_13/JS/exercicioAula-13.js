...
let id_1 = document.querySelector('#B_01');
let id_2 = document.querySelector('#B_02');
let id_3 = document.querySelector('#B_03');
let id_4 = document.querySelector('#B_04');
...
function clicar_01() {
    ...
    let sectionImg = document.querySelector('#imagem');
...
function clicar_02() {
    let sectionNome = document.querySelector('#nomePrompt');
...
function clicar_03() {
    ...
    let sectionTabuada = document.querySelector('#tabuada');
...
id_4.addEventListener('click', excluir)
...
function excluir() {
    ...
    let sectionTabuada = document.querySelector('#tabuada');
    let nome = sectionNome.getElementsByTagName('p');
    let img = sectionImg.getElementsByTagName('img');
    let h2 = sectionTabuada.getElementsByTagName('h2');
    sectionNome.remove(nome);
    sectionImg.remove(img);
    sectionTabuada.remove(h2);
}